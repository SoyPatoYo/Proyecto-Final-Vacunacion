...
public class CargarCita extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (dniStr.length() < 7 || dniStr.length() > 8 || dniStr.startsWith("0")) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (textNombre.getText().isEmpty()) {
            ...
            List<Cita> citasPorPersona = citaD.listarCitasPorPersonaPendiente(persona.getIdCiudadano());
            boolean bandera = false;
            Cita x = new Cita();
            if (citasPorPersona.isEmpty()) {
                bandera = true;
            }
            List<Cita> citasXPersona = citaD.listarCitasPorPersona(persona.getIdCiudadano());
            for (Cita c : citasXPersona) {
                if (c.isColocada()) {
                    x = c;
                } else {
                    x = c;
